...
We are aiming to recruit about 140 adult participants, allowing us to test roughly 70 participants per each of our two experimental conditions. We will not be controlling for demographic characteristics such as age, gender, and so on. Once target participation is met, data collection will be terminated.
